package net.flashpunk.masks
{
	...
	public class Grid extends Hitbox
	{
		 ...
		 */
		public function getSubMap (x:int, y:int, w:int, h:int):Grid
		{
			var newMap:Grid = new Grid(w*_tile.width, h*_tile.height, _tile.width, _tile.height);
			
			for (var _x:int = 0; _x < w; ++_x)
				for (var _y:int = 0; _y < h; ++_y)
					{
						newMap.setTile(_x, _y, getTile(_x + x, _y + y));
					}
