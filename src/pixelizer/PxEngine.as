package pixelizer {
	...
	public class PxEngine extends Sprite {
		...
		private static var _renderer : IPxRenderer;
		private static var _logicStats : PxLogicStats;
		...
		private static var _internalScene : PxScene;
		private static var _performaceView : PxTextFieldEntity = null;
		private static var _logView : PxTextFieldEntity = null;
		private static var _logTexts : Array = [];
